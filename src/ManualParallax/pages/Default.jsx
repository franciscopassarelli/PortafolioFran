...
const Default = () =>{
  ...
  const [urls, setUrls] = useState({
    ...
    cv: 'file:///C:/Users/franc/Downloads/CurriculumFranciscoPassarelli.pdf',
...
<h3 className="primertitulo">Sobre mí</h3>
   <p className="title">Empecé en el mundo de la programación a mediados de 2021/2022. Orientado en el desarrollo front-end con React Y Next JS en 
Coderhouse, tambien estudiante universitario. Con el paso del tiempo, he ido aprendiendo y ahora soy 
capaz de adquirir conocimientos de manera autodidacta, adaptándome y aprendiendo nuevas tecnologías.</p>
       </div>
       ...
       <div className="caption">
           <span className="border">Tecnicatura Universitaria en Tecnologías Web.
           </span>
